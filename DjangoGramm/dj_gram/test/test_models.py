...
class TestCustomUserModel(TestCase):
    ...
    def setUpTestData(cls):
        ...
        superuser = CustomUser.create_superuser(email='admin@admin.admin')
    ...
    def test_customuser_username_field(self):
        ...
        self.assertEqual(user_field, 'email')
...
class TestTag(TestCase):
    ...
    def test_tag_save(self):
        tag = Tag.objects.get(id=1)
        self.assertFalse(isupper(tag.name))
...
class TestVote(TestCase):
    ...
    def setUpTestData(cls):
        ...
        Vote.objects.create(profile=user, post=post)
    ...
    def test_vote_profile_related_name(self):
        related_name = Vote._meta.get_field('profile').related_name
    ...
    def test_vote_profile_related_name(self):
        related_name = Vote._meta.get_field('post').related_name
        self.assertEqual(related_name, 'votes')
